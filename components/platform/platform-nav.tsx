...
const NAV_ITEMS = ["Features", "AI Employees", "Pricing", "Marketing", "FAQ"]
    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-xl border-b border-primary/10">
      <div className="mx-auto max-w-[1200px] px-6 flex items-center justify-between h-[70px]">
        <Link href="/" className="flex items-center gap-2">
          <Image
            ...
            loading="eager"
          />
          <span className="text-foreground text-sm font-semibold tracking-[0.12em] uppercase">
            Platform
          </span>
        </Link>
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <a
            href="/contact"
            className="bg-primary text-primary-foreground px-6 py-2.5 text-sm font-semibold rounded-md hover:bg-primary-hover transition-all hover:-translate-y-0.5 cursor-pointer inline-block"
          >
            Get Started
          </a>
        </div>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden fixed top-[70px] left-0 right-0 bottom-0 bg-background/98 backdrop-blur-xl z-40 px-6 py-10 flex flex-col gap-6">
          ...
          <a
            href="/contact"
            className="bg-primary text-primary-foreground px-8 py-3.5 text-base font-semibold rounded-md mt-4 cursor-pointer inline-block"
          >
            Get Started
          </a>
        </div>
